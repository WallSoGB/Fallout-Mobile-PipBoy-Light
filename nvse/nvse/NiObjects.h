...
public:
	...
	virtual NiAVObject*		GetObject(const NiFixedString& kName);
	...
	virtual void			UpdateDownwardPass(NiUpdateData* arData, UInt32 uFlags);
	...
	virtual void			PreAttachUpdate(NiNode* pEventualParent, NiUpdateData* arData);
	virtual void			PreAttachUpdateProperties(NiNode* pEventualParent);
	virtual void			DetachParent(void* arg);
	virtual void			UpdateUpwardPassParent(void);
...
public:
	...
	virtual void AddObjectAt(NiAVObject* pkChild);
	virtual void RemoveObject(NiAVObject* toRemove, NiAVObject** out);
	virtual void DetachChild(NiAVObject* pkChild);
	virtual void DetachChildAt();
	virtual NiAVObject* DetachChildAt0(UInt32 i, NiAVObject* pkChild);
	virtual NiAVObject* SetAt(UInt32 i, NiAVObject* pkChild);
	virtual NiAVObject* SetAt2(UInt32 i, NiAVObject* pkChild);
